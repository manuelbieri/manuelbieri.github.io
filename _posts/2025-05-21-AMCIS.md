...
<br><br>
Bieri, M., & Matt, C. (2025). Algorithmic fairness in shift scheduling – Assessing the fairness perceptions of healthcare workers. <em>Proceedings of the 2025 Americas Conference on Information Systems</em> (DOI: [10.48620/88159<i class="bi-box-arrow-up-right link-icon"></i>](https://doi.org/10.48620/88159){:target="_blank"}).
